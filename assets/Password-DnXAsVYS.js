import{r,aC as T,aD as H,aE as U,j as e,aF as O,aG as G,aH as V,b as A,i as q,s as z,B as w,N as J,P as R,u as Q,a as Z,K as ee,aI as te,M as re,ah as N,T as S,m as ne}from"./index-DpUyOFN7.js";function W(){const t=r.useRef(!1);return T(()=>(t.current=!0,()=>{t.current=!1}),[]),t}function se(){const t=W(),[i,n]=r.useState(0),a=r.useCallback(()=>{t.current&&n(i+1)},[i]);return[r.useCallback(()=>H.postRender(a),[a]),i]}class oe extends r.Component{getSnapshotBeforeUpdate(i){const n=this.props.childRef.current;if(n&&i.isPresent&&!this.props.isPresent){const a=this.props.sizeRef.current;a.height=n.offsetHeight||0,a.width=n.offsetWidth||0,a.top=n.offsetTop,a.left=n.offsetLeft}return null}componentDidUpdate(){}render(){return this.props.children}}function ae({children:t,isPresent:i}){const n=r.useId(),a=r.useRef(null),y=r.useRef({width:0,height:0,top:0,left:0}),{nonce:g}=r.useContext(U);return r.useInsertionEffect(()=>{const{width:u,height:x,top:j,left:b}=y.current;if(i||!a.current||!u||!x)return;a.current.dataset.motionPopId=n;const s=document.createElement("style");return g&&(s.nonce=g),document.head.appendChild(s),s.sheet&&s.sheet.insertRule(`
