import{s as g,B as h,m as k,P as j,j as a,T as m,r as y,R as b,u as B,a as I}from"./index-DpUyOFN7.js";import{u as A}from"./useMediaQuery-CRo94WYx.js";const O=g(h)`
  width: 90%;
  max-width: 500px;
  overflow-y: auto;
  position: absolute;
...
`,L=k(O),D=g(h)`
  ...
  padding: 15px;
  scrollbar-width: thin;
`,N=k(D),M=g(h)(({theme:i,imageurl:n})=>({width:"100%",position:"relative",backgroundImage:`url(${n})`,[i.breakpoints.up("lg")]:{height:"600px"},[i.breakpoints.between(900,1200)]:{height:"500px"},[i.breakpoints.between(400,900)]:{height:"400px"},[i.breakpoints.down(400)]:{height:"300px"},backgroundPosition:"center",backgroundSize:"cover",backgroundRepeat:"no-repeat",borderRadius:"5px"})),H=k(M);function P({arr:i}){const n=A("(min-width:500px)");return a.jsx(a.Fragment,{children:a.jsx(h,{sx:{width:"100%",marginTop:6,marginBottom:6,display:"flex",alignItems:"center",flexDirection:"column",gap:5},children:i.map(({title:t,description:e,imageUrl:s,id:o},r)=>a.jsxs(H,{id:o,initial:{y:70},whileInView:{y:0},transition:{type:"spring",bounce:.4,duration:.8},viewport:{once:!0},imageurl:s,children:[a.jsx(L,{initial:{opacity:0},whileInView:{opacity:1},transition:{duration:.8},viewport:{once:!0,amount:1},children:a.jsx(m,{textAlign:"center",variant:n?"h5":"h6",children:t})}),a.jsx(N,{matches500:String(n),initial:{opacity:0},whileInView:{opacity:1},transition:{duration:.8},viewport:{once:!0,amount:.8},children:a.jsx(m,{textAlign:"center",variant:n?"body1":"body2",component:"p",children:e})})]},r))})})}P.propTypes={arr:j.array};const w="/languagelift/assets/cathedral-EMdNVelu.jpg",C="/languagelift/assets/city-qShvSBbv.jpg",T="/languagelift/assets/natural-history-museum-D6XOY4a0.jpg",q={en:[{title:"Interactive Language Lessons",description:"Engage in interactive lessons designed to improve your English skills. Practice speaking, listening, reading, and writing in a fun and effective way.",imageUrl:w},{title:"Personalized Learning Experience",description:"Receive a personalized learning experience tailored to your needs and learning pace. Our platform adapts to your progress and provides targeted exercises and feedback.",imageUrl:C},{title:"Language Practice Anytime, Anywhere",description:"Practice English whenever and wherever you want with our mobile-friendly platform. Access lessons, quizzes, and resources on your smartphone or tablet.",imageUrl:T}],ua:[{title:"Інтерактивні уроки англійської",description:"Беріть участь у інтерактивних уроках, спрямованих на покращення вашої англійської. Практикуйте говоріння, слухання, читання та письмо в цікавий та ефективний спосіб.",imageUrl:w},{title:"Персоналізований досвід навчання",description:"Отримуйте персоналізований досвід навчання, підготовлений під ваші потреби та темп навчання. Наша платформа адаптується до вашого прогресу та надає цілеспрямовані вправи та зворотний зв'язок.",imageUrl:C},{title:"Практикуйте мову в будь-який час і в будь-якому місці",description:"Практикуйте англійську мову в будь-який час і в будь-якому місці з нашою мобільною платформою. Отримайте доступ до уроків, тестів та ресурсів на своєму смартфоні або планшеті.",imageUrl:T}]},F={en:"Your path to a brighter future starts here",ua:"Ваш шлях до яскравого майбутнього починається тут"},R="/languagelift/assets/road-BNxpMxvb.jpg",z="/languagelift/assets/london-bridge-Da9NWUIt.jpg",U=g(h)`
  width: 100%;
  height: 100%;
